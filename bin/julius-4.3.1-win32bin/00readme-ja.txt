Windows バイナリパッケージ of Julius-4.3.1
===========================================

このパッケージについて
=======================

これは Julius-4.3.1 の Windows用実行バイナリ配布パッケージです．
Julius Rev.4.3.1 の Windows 用実行バイナリおよびライブラリが含まれています．
...
コンパイルは cygwin-1.7.27 でクロスコンパイラ i686-w64-mingw32-gcc を
用いて行われました．
...
同梱の以下の文書をご覧ください．
    ...
    00readme-julius-ja.txt  Julius-4.3.1 readme
    LICENSE.txt		    利用許諾
