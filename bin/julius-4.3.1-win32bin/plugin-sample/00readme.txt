...
If you compile on cygwin and want it to run without cygwin, there are
two ways depending on gcc version.
...
With version 4:
    ...
    % i686-w64-mingw32-gcc -shared -o result.jpi result.c
